				 ...
				 <div class="container-fluid">      
					...
					<div class="card bg-dark shadow text-white" id="centralizar" style="width:400px;margin: 20px auto;">
						<div class="card-body">
							...
							<form method="post" id="register" class="p-1" >
								<legend><center>CADASTRO DE USUÁRIOS</center></legend>   
							   
								<div>
									<label id="la" for="no" class="form-label  ">Nome</label>
									<input type="text" id="no" name="nome" class="form-control">
								</div>
								<div>
								...
								<div>
									...
									<input type="password" id="se" name="senha"  class="form-control">
								</div>
								<div>
									<label for="cse"class="form-label  " >Confirmar senha</label>
									<input type="password" id="cse" name="csenha" class="form-control">
								</div>
								
								
								<div><input  class="form-control my-3" type="submit" name="enviar" value="registrar"></div>
							</form>
